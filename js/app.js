...
let slider_about = new Swiper('.project__swiper', {
	// effect: 'fade',
...
let slider_about2 = new Swiper('.project__review', {
	// effect: 'fade',
...
let contes = document.querySelectorAll('.reviews__contes');
contes.forEach(element => {
   let buttonSpan = element.querySelector('.reviews__span');
   let boxSpan = element.querySelector('.reviews__box');
      if(buttonSpan){
         buttonSpan.addEventListener('click', function (e) {
            buttonSpan.classList.add("hidenSpan");
            boxSpan.classList.add("hidenBox");
         }, false);
      }
});
